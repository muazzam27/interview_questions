...
* What are anonymous classes? [example](https://www.javatpoint.com/anonymous-inner-class)
* What is the difference between using `==` and `.equals` on a string? [example](https://stackoverflow.com/questions/7520432/what-is-the-difference-between-vs-equals-in-java)
...
* Tell all the Android application components.[example](https://www.tutorialspoint.com/android/android_application_components.htm)
